...
<style>
  ...
  .bz-hero-h1-sub.bz-hero-h1-sub.bz-hero-h1-sub.bz-hero-h1-sub {
    ...
    margin: 0 0 24px !important; letter-spacing: -0.01em !important;
    ...
    <CopyWrapper blockName="BuddzeeHero" codeToCopy={BuddzeeHeroCode}>
      <section className="relative py-28 lg:py-36 bg-white overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-10 text-center">
          ...
          {/* Headline */}
          <h1 className="font-buddzee text-5xl md:text-6xl lg:text-[76px] font-extrabold leading-[1.05] tracking-tight mb-4" style={{ color: '#09142B' }}>
            Your Business Data Buddy.
          </h1>
          {/* Gradient subline */}
          <div className="font-buddzee text-4xl md:text-5xl lg:text-[56px] font-extrabold leading-[1.2] tracking-tight mb-6 bg-clip-text text-transparent" style={{ backgroundImage: 'linear-gradient(135deg, #ABC1FF 0%, #5284FF 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
