...
<style>
  ...
  .bz-hero-breadcrumb {
    ...
    font-family: var(--font-buddzee) !important; font-size: 12px !important;
  ...
  @media (min-width: 1024px) { .bz-hero-h1.bz-hero-h1.bz-hero-h1.bz-hero-h1 { font-size: 76px !important; } }
  .bz-hero-h1-sub.bz-hero-h1-sub.bz-hero-h1-sub.bz-hero-h1-sub {
    font-family: var(--font-buddzee) !important; font-weight: 800 !important;
    font-size: 36px !important; line-height: 1.2 !important;
    margin: 0 0 32px !important; letter-spacing: -0.01em !important;
    background: linear-gradient(135deg, var(--bz-blue-light) 0%, var(--bz-blue) 100%) !important;
    -webkit-background-clip: text !important; -webkit-text-fill-color: transparent !important;
    background-clip: text !important;
  }
  @media (min-width: 768px) { .bz-hero-h1-sub.bz-hero-h1-sub.bz-hero-h1-sub.bz-hero-h1-sub { font-size: 48px !important; } }
  @media (min-width: 1024px) { .bz-hero-h1-sub.bz-hero-h1-sub.bz-hero-h1-sub.bz-hero-h1-sub { font-size: 56px !important; } }
  .bz-hero-sub {
...
<section id="bz-hero">
  ...
  <div class="bz-hero-container">
    ...
    <h1 class="bz-hero-h1">Your Business Data Buddy.</h1>
    <div class="bz-hero-h1-sub">Ask Anything. Know Everything.</div>
    <p class="bz-hero-sub">Buddzee connects your tools, unifies your data, and answers your questions in plain English. Less admin. More clarity. Total confidence.</p>
    <div class="bz-hero-actions">
      <a href="#bz-how" class="bz-hero-cta">See How It Works</a>
      <a href="/contact" class="bz-hero-secondary">Book a Demo</a>
    </div>
  </div>
</section>
`;
    ...
    <CopyWrapper blockName="BuddzeeHero" codeToCopy={BuddzeeHeroCode}>
      <section className="relative py-28 lg:py-36 bg-white overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-10 text-center">
          {/* Breadcrumb */}
          <div className="inline-flex items-center gap-2 text-xs text-gray-400 mb-6 font-buddzee">
          ...
          {/* Headline */}
          <h1 className="font-buddzee text-5xl md:text-6xl lg:text-[76px] font-extrabold leading-[1.05] tracking-tight mb-6" style={{ color: '#09142B' }}>
            Your Business Data Buddy.
          </h1>
          {/* Gradient subline */}
          <div className="font-buddzee text-4xl md:text-5xl lg:text-[56px] font-extrabold leading-[1.2] tracking-tight mb-8 bg-clip-text text-transparent" style={{ backgroundImage: 'linear-gradient(135deg, #ABC1FF 0%, #5284FF 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
            Ask Anything. Know Everything.
          </div>
          {/* Subtext */}
          <p className="font-buddzee text-lg text-gray-500 font-medium leading-relaxed max-w-[680px] mx-auto mb-10">
            Buddzee connects your tools, unifies your data, and answers your questions in plain English. Less admin. More clarity. Total confidence.
          </p>
          {/* CTAs */}
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
            <a
              href="#bz-how"
              className="inline-flex items-center gap-2 text-white px-7 py-3.5 rounded-[10px] text-sm font-extrabold uppercase tracking-wider hover:-translate-y-0.5 transition-all no-underline font-buddzee"
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-2 px-7 py-3.5 rounded-[10px] text-sm font-bold transition-all no-underline font-buddzee"
