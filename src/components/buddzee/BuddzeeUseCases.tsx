...
<style>
  ...
  .bzu-label { display: inline-block !important; font-family: var(--font-buddzee) !important; font-size: 12px !important; font-weight: 800 !important; color: var(--bz-blue) !important; text-transform: uppercase !important; letter-spacing: 0.15em !important; margin-bottom: 16px !important; }
  .bzu-h2.bzu-h2.bzu-h2.bzu-h2 { font-family: var(--font-buddzee) !important; font-weight: 800 !important; font-size: 36px !important; line-height: 1.15 !important; color: var(--bz-navy) !important; margin: 0 0 16px !important; letter-spacing: -0.02em !important; }
  @media (min-width: 768px) { .bzu-h2.bzu-h2.bzu-h2.bzu-h2 { font-size: 44px !important; } }
  .bzu-intro { font-family: var(--font-buddzee) !important; font-size: 17px !important; color: #6b7280 !important; line-height: 1.7 !important; max-width: 600px !important; margin-bottom: 56px !important; }
    ...
    <CopyWrapper blockName="BuddzeeUseCases" codeToCopy={BuddzeeUseCasesCode}>
      <section className="py-24 lg:py-28 bg-white">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          <div className="text-xs font-800 uppercase tracking-[0.15em] mb-4" style={{ color: '#5284FF', fontFamily: "'Manrope', sans-serif" }}>Use Cases</div>
          ...
          <p className="text-[17px] text-gray-500 leading-relaxed max-w-[600px] mb-14" style={{ fontFamily: "'Manrope', sans-serif" }}>
