...
<section id="bz-faq">
  <div class="bzfq-container">
    ...
    <div class="bzfq-list">
      ...
      <div class="bzfq-item"><button class="bzfq-q" onclick="this.parentElement.classList.toggle('active')">Is my data secure? <svg class="bzfq-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M19 9l-7 7-7-7"/></svg></button><div class="bzfq-a"><div class="bzfq-a-text">Absolutely. Buddzee runs on enterprise-grade OVHcloud infrastructure with bank-level encryption. We use strict access controls, three tiers of redundant data protection, and all connections are encrypted end-to-end. Need hosting in a specific region? We offer deployment across North America, Asia Pacific, and Europe.</div></div></div>
...
export const BuddzeeFAQ: React.FC = () => {
  ...
  const items = [
    ...
    {
      q: 'Is my data secure?',
      a: 'Absolutely. Buddzee runs on enterprise-grade OVHcloud infrastructure with bank-level encryption. We use strict access controls, three tiers of redundant data protection, and all connections are encrypted end-to-end. Need hosting in a specific region? We offer deployment across North America, Asia Pacific, and Europe.',
    },
    {
