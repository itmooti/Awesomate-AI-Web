...
<style>
  ...
  .bzfq-container {
    max-width: 800px !important; margin: 0 auto !important; padding: 0 24px !important;
  }
  ...
  .bzfq-q.bzfq-q.bzfq-q.bzfq-q {
    ...
    font-family: var(--font-buddzee) !important; font-size: 16px !important; font-weight: 700 !important;
...
export const BuddzeeFAQ: React.FC = () => {
  ...
  const items = [
    {
      q: 'What is Buddzee?',
      a: 'Buddzee is your business data buddy. It connects all your business tools into one unified data layer, then lets you ask questions in plain English to get instant, accurate answers. Think of it as a brilliant assistant that actually knows everything happening in your business.',
    },
    {
      q: 'What tools does Buddzee connect to?',
      a: 'Buddzee integrates with most popular business tools \u2014 CRMs like HubSpot and Salesforce, accounting tools like Xero and MYOB, project management platforms, e-commerce systems like Shopify, marketing tools, and more. If it has an API, Buddzee can probably connect to it.',
    },
    {
      q: 'Is my data secure?',
      a: 'Absolutely. Buddzee runs on Australian-hosted infrastructure with enterprise-grade encryption. Your data never leaves the country. We use role-based access controls, and all connections are encrypted end-to-end.',
    },
    {
      q: 'How long does setup take?',
      a: 'Most businesses are up and running within a week. We handle the technical setup \u2014 connecting your tools, configuring your data model, and training Buddzee on your business context. You don\u2019t need to do anything technical.',
    },
    {
    ...
    <CopyWrapper blockName="BuddzeeFAQ" codeToCopy={BuddzeeFAQCode}>
      <section id="bz-faq" className="py-24 lg:py-28 bg-white">
        <div className="max-w-[800px] mx-auto px-6">
          <h2
            className="text-4xl md:text-[44px] font-800 leading-[1.15] tracking-tight text-center mb-12"
