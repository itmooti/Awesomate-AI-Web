...
<section id="n8-cta">
  ...
  <div class="n8c-container">
    <h2 class="n8c-h2">Start Your Managed n8n Hosting Today</h2>
    <p class="n8c-sub">Stop worrying about uptime and start focusing on what your automations can do for your business.</p>
      ...
      <section className="py-24 lg:py-28 bg-[#0a0e1a] relative overflow-hidden">
        ...
        <div className="max-w-[720px] mx-auto px-6 text-center relative z-10">
          <h2 className="text-4xl md:text-5xl font-800 text-white leading-[1.15] tracking-tight mb-5">
            Start Your Managed n8n Hosting Today
          </h2>
          <p className="text-[17px] text-white/50 leading-relaxed max-w-[520px] mx-auto mb-9">
            Stop worrying about uptime and start focusing on what your automations can do for your business.
          </p>
