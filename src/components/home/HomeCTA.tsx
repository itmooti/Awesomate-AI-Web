...
<style>
  ...
  .hm-cta-glow {
    ...
    transform: translate(-50%, -50%) !important; width: 600px !important; height: 600px !important;
    background: radial-gradient(circle, rgba(233,72,77,0.08) 0%, transparent 60%) !important;
  ...
  @media (min-width: 768px) {
    .hm-cta-h2.hm-cta-h2.hm-cta-h2.hm-cta-h2 { font-size: 48px !important; }
  }
  .hm-cta-sub {
  ...
  .hm-cta-btn:hover { transform: translateY(-2px) !important; box-shadow: 0 16px 40px rgba(233,72,77,0.35) !important; }
  .hm-cta-btn svg { width: 18px !important; height: 18px !important; }
  .hm-cta-note {
  ...
  .hm-cta-mark { position: absolute !important; right: -50px !important; top: 50% !important; transform: translateY(-50%) rotate(15deg) !important; width: 350px !important; height: 350px !important; opacity: 0.04 !important; pointer-events: none !important; }
</style>

<section id="hm-cta">
  <div class="hm-cta-glow"></div>
  ...
  <div class="hm-cta-container">
    ...
    <p class="hm-cta-sub">Book a free discovery call. We'll map your data, your automations, and your biggest opportunities — then show you exactly what's possible.</p>
    <a href="https://awesomate.ai/discovery" class="hm-cta-btn">
      Book a Free Discovery Call
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14m-7-7l7 7-7 7"/></svg>
    </a>
    <p class="hm-cta-note">No commitment. No jargon. Just a conversation about your business.</p>
  </div>
</section>
`;
...
export const HomeCTA: React.FC = () => {
  return (
    <CopyWrapper blockName="HomeCTA" codeToCopy={HomeCTACode}>
      <section className="py-24 lg:py-28 bg-[#0a0e1a] relative overflow-hidden">
        {/* Glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[radial-gradient(circle,_rgba(233,72,77,0.08)_0%,_transparent_60%)] pointer-events-none" />
        ...
        <div className="max-w-[720px] mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-[17px] text-white/50 leading-relaxed max-w-[520px] mx-auto mb-9">
            Book a free discovery call. We'll map your data, your automations, and your biggest opportunities — then show you exactly what's possible.
          </p>
          <a href="https://awesomate.ai/discovery" className="inline-flex items-center gap-2 bg-gradient-to-br from-brand-accent to-brand-orange text-white px-9 py-4 rounded-[10px] text-[15px] font-800 uppercase tracking-wider shadow-lg shadow-brand-accent/25 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-brand-accent/35 transition-all no-underline">
            Book a Free Discovery Call
          ...
          <p className="text-[13px] text-white/30 mt-5">No commitment. No jargon. Just a conversation about your business.</p>
        </div>
      </section>
    </CopyWrapper>
  );
