...
<style>
  ...
  .ab-story-img { border-radius: 24px !important; background: white !important; height: 400px !important; display: flex !important; align-items: center !important; justify-content: center !important; font-family: var(--font-main) !important; font-size: 14px !important; color: #d1d5db !important; border: 2px dashed #e5e7eb !important; }
</style>
...
<section id="ab-story">
  <div class="ab-story-container">
    <div class="ab-story-grid">
      ...
      <div class="ab-story-img">Story illustration placeholder</div>
    </div>
  </div>
</section>
`;
      ...
      <section className="py-24 lg:py-28 bg-[#f8f9fb]">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-14 items-center">
            ...
            <div className="rounded-3xl bg-white h-[400px] flex items-center justify-center text-sm text-gray-300 border-2 border-dashed border-gray-200">
